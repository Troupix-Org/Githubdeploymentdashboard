        ...
        >
          <AlertDialogHeader>
            ...
            <AlertDialogDescription style={{ color: "#cbd5e1" }}>
              This will permanently delete this deployment record. This action
              cannot be undone.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
      ...
      >
        ...
        >
          <AlertDialogHeader>
            ...
            <AlertDialogDescription style={{ color: "#cbd5e1" }}>
              This will permanently delete all deployments in this batch. This
              action cannot be undone.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
            <AlertDialogCancel onClick={() => setDeleteBatchDialogOpen(false)}>
              Cancel
            </AlertDialogCancel>
            <AlertDialogAction
